...
@media only screen and (min-width: 1200px) {
  ...
  <div class="container" style="display: flex; justify-content: flex-end; align-items: center; color: white; padding: 20px;">
      ...
      <div class="container">
        <div class="navbar navbar_ clearfix">
          <div class="navbar-inner">
              ...
              <?php
              $currentPage = 'articles'; // Define this variable according to the current page
              include('menu.php');
              ?>  
    ...
    $results_per_page = 5; // Number of articles displayed per page
    ...
    // Calculate total pages for published articles
...
<?php
    ...
    $sql = "SELECT id, title, publication_date FROM articles WHERE status = 'published'";
