...
if(isset($_POST['submit'])) {
    ...
    if ($query->execute()) {
        ...
        $error = "Failed to update package image. Please try again.";
    }
}

// Fetch the current package image
$sql = "SELECT PackageImage FROM tbltourpackages WHERE PackageId = :imgid";
$query = $dbh->prepare($sql);
$query->bindParam(':imgid', $imgid, PDO::PARAM_INT);
$query->execute();
$result = $query->fetch(PDO::FETCH_ASSOC);
$currentImage = $result['PackageImage'];
?>
<!DOCTYPE HTML>
<html>
<head>
<title>THALLATTA | ΑΛΛΑΓΗ ΕΙΚΟΝΑΣ</title>
                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
							<img src="pacakgeimages/<?php echo htmlentities($currentImage ?? '', ENT_QUOTES, 'UTF-8'); ?>" width="200">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">ΝΕΑ ΦΩΤΟΓΡΑΦΙΑ</label>
                            <div class="col-sm-8">
