...
<html>
<head>
<title>THALATTA | ΔΙΑΧΕΙΡΗΣΗ ΚΡΑΤΗΣΕΩΝ</title>
...
{
echo "ΑΚΥΡΩΘΗΚΕ ΑΠΟ ΣΑΣ ΣΤΙΣ " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='u')
{
echo "ΑΚΥΡΩΘΗΚΕ ΑΠΟ ΤΟΝ ΧΡΗΣΤΗ ΣΤΗΣ" .$result->upddate;
...
<?php elseif($result->status == 1) : ?>
	ΕΓΚΡΙΘΗΚΕ
<?php else : ?>
	<a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')">ΑΚΥΡΟΣΗ</a> / 
	<a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to confirm booking')">ΕΓΚΡΙΣΗ</a>
<?php endif; ?>
</td>
