...
<html>
<head>
<title>ΔΙΑΧΕΙΡΙΣΗ ΠΑΚΕΤΩΝ</title>
...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->TourDate);?></td>
							<td>
        ...
        <br>
        <a href="delete-package.php?pid=<?php echo htmlentities($result->PackageId);?>">
